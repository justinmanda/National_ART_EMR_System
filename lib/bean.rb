class PatientBean 
 ...
 attr_accessor :date, :weight, :height, :bmi, :outcome, :reg, :s_eff, :sk , :pn, :hp, :pills, :gave, 
   ...
   :home_district, :birth_date, :traditional_authority, :current_residence,:country, :mothers_surname, :eid_number, :pre_art_number, :dead,
 ...
 attr_accessor :patient_id,:arv_number, :national_id ,:name ,:age ,:sex, :init_wt, :init_ht ,
   ...
   :second_line_drugs, :date_of_first_alt_line_regimen, :country,:date_of_second_line_regimen, :transfer_in_date,
