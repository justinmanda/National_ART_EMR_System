class Encounter < ActiveRecord::Base
  ...
  belongs_to :provider, :class_name => "Person", :foreign_key => :provider_id, :conditions => {:voided => 0},:dependent=>:destroy
  belongs_to :patient,:dependent=>:destroy, :conditions => {:voided => 0}
